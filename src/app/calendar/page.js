...
function CalendarContent() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#4E4034] pb-24">
      {/* Fixed top section - header and date selector - LOCKED */}
      <div className="fixed top-0 left-0 right-0 bg-[#F7F6F3] z-50">
        ...
        <div ref={stripRef} className="flex gap-2 overflow-x-hidden px-3 pt-2 pb-1 mb-3 bg-[#ECEAE6] rounded-md bg-white scroll-smooth" style={{ overscrollBehavior: 'none' }}>
        {stripDays.map((d, i) => {
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: toRGBA(renderColor, 0.4),
      ...
      <button
        ...
        className="fixed bottom-20 right-4 bg-[#8CA4AF] text-white rounded-full w-12 h-12 flex items-center justify-center text-2xl shadow-md z-[60]"
      ...
      <div className="fixed bottom-0 left-0 right-0 p-3 pb-7 z-[60]">
