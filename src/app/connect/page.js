      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4">
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
          {(searchResults?.podcasts || [
            { title: "Founders", desc: "Biographies of the world's greatest entrepreneurs by David Senra", url: "https://podcasts.apple.com/podcast/id1141877104", spotifyUrl: "https://open.spotify.com/show/6v2w0ycjdgSUnRtO4qBumX" },
